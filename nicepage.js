            ...
            return {
                submi: function(t) {
                    ...
                    if ("email" === e && !p(form).find('input[name="npspec-referer"]').length)
                        p(form).append('<input type="hidden" name="npspec-referer" value="' + window.location.href + '">');
 ...
 */
            ...
            return function(t) {
                ...
                function u(t, e, n) {
                    ...
                    for (var S = 1; S <= C; S++) {
                        ...
                        M && (N += " qs-empty",
                        L = ""),
                        q.push('<div class="' + N + '" data-direction="' + k + '">' + L + "</div>")
                    }
    ...
    11500: function(t, e, n) {
        ...
        i.prototype.createTotalPrice = function t(e, n, data) {
            ...
            s.text("Total"),
            a.append(s);
            var u = o('<div class="payment-total-price"/>'), layout;
        ...
        i((function() {
            c.handle((function(routes) {
                i(".u-products").each((function() {
                    var list = i(this), t = list.attr("data-products-id"), e;
              ...
              , Carousel = function() {
                ...
                e._addTouchEventListeners = function t() {
                    ...
                    if (this._touchSupported) {
                        ...
                        if (s["default"](this._element.querySelectorAll(tt)).on(F, (function(t) {
                            return t.preventDefault()
                        }
                        )),
                        this._pointerEvent)
